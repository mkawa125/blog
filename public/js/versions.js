...
function showAddVersionErrors(errors) {
  ...
  if (errors.build_number != null){
      $("#build_number_error").text(errors.build_number);
      $("#build_number_error").fadeIn(0);
  }
}
...
function showEditVersionErrors(errors) {
  ...
  if (errors.build_number != null){
    $("#edit_build_number_error").text(errors.build_number);
    $("#edit_build_number_error").fadeIn(0);
  }
}
...
function showEditVersionModal(version) {
  ...
  $("#edit_build_number").val(version.build_number);
