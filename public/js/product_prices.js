...
function showAddPriceErrors(errors) {
  ...
  if(errors.rwanda != null) {
    $("#edit_rwanda_price_error").text(errors.rwanda);
    $("#edit_rwanda_price_error").fadeIn(0);
  }
  if(errors.burundi != null) {
    $("#edit_burundi_price_error").text(errors.burundi);
    $("#edit_burundi_price_error").fadeIn(0);
  }
}
...
function showEditPriceModal(price) {
  ...
  $("#edit_rwanda").val(price.rwanda);

  $("#edit_burundi").val(price.burundi);
}
...
function applyTheUpdates(price) {
  ...
  $("#rwanda_" + price.rwanda).text(price.rwanda);
  $("#burundi_" + price.burundi).text(price.burundi);
}
